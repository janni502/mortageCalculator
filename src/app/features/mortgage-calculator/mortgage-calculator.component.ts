...
import { MortgageDetail } from './mortgage-calculator.models';
...
export class MortgageCalculatorComponent {
  ...
  public getNumOfPays(frequency: string, months: number): number {
    switch (frequency) {
      case "AccW": // Accelerated Weekly
        return 52 * months / 12;
      case "W": // Weekly
        return 52 * months / 12;
      case "AccBiW":
        return 52 * months / 12 / 2;
      case "BiW": // Accelerated Bi-weekly
        return 52 * months / 12 / 2;
      case "SemiM": // Semi-monthly (24x per year)
        return 2 * months;
      case "M": // Monthly (12x per year)
        return months;
      default:
